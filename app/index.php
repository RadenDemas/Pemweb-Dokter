...
<nav class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-menu">
            ...
            <a href="dokter.php" class="nav-link">Dokter</a>
            ...
            <?php if($_SESSION['login'] == true): ?>
                <div class="profile-menu">
                    ...
                    <div class="profile-dropdown">
                        <a href="profile.php" class="dropdown-item">Lihat Akun</a>
                        <a href="edit-pengguna.php" class="dropdown-item">Edit Akun</a>
                        <a href="../scripts/php/kill.php" class="dropdown-item">Sign Out</a>
                    </div>
                </div>
            <?php elseif($_SESSION['login'] == false): ?>
                <a href="signin.php" class="logout-btn">Log In</a>
            <?php endif;?>
        </div>
    </div>
</nav>
    ...
    <section class="doctors">
        ...
        <div class="doctors-grid">
            <div class="doctor-card">
                ...
                <h3>dr. Kim Sabu,</h3>
                <h3>Sp.PD.</h3>
                <button><a href="profile-dokter.php?id=1">Lihat Profil</a></button>
            </div>
            <div class="doctor-card">
                <p>Anak</p>
                ...
                <h3>Sp.A.</h3>
                <button><a href="profile-dokter.php?id=2">Lihat Profil</a></button>
            </div>
            <div class="doctor-card">
                <p>Penyakit Dalam</p>
                ...
                <h3>dr. Lee Ik Jun,</h3>
                <h3>Sp.PD.</h3>
                <button><a href=profile-dokter.php?id=3">Lihat Profil</a></button>
            </div>
        </div>
    </section>
...
<!--                    <button><i class='bx bx-chevron-right'><a href="artikel.php?id=--><?php //echo $row['id_artikel'];?><!--"></a></i></button>-->
                    <button><a href="artikel.php?id=<?php echo $row['id_artikel'];?>"></a>Baca</button>
                </div>
            <?php endwhile;?>
        </div>
    </section>

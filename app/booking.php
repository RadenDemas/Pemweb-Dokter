...
<main>
    <h1>Booking Dokter di Pelita Harapan Clinic</h1>
        ...
        <?php foreach ($schedules as $dokter => $data):?>
            <div class="doctor-card">
                ...
                <div class="doctor-info">
                    ...
                    <button class="profile-btn"><a style="text-decoration: none;color: white" href="booking-dokter.php?id=<?php echo $data['id_dokter'];?>">Booking Dokter</a></button>
                </div>
            </div>
        <?php endforeach;?>
    </div>
